...
<html>
    ...
    <body>
        ...
        <p><b>US Flight Delay Analysis</b> is a project built for <a href="https://wiki.smu.edu.sg/1415t1is428/Main_Page">IS428 Visual Analytics for Business Intelligence</a> for exploring large multivariate datasets in the browser. Crossfilter supports extremely fast (&lt;30ms) interaction with coordinated views, even with datasets containing a million or more records; we built it to power analytics for <a href="https://squareup.com/register">Square Register</a>, allowing merchants to slice and dice their payment history fluidly.
        <p>Since most interactions only involve a single dimension, and then only small adjustments are made to the filter values, incremental filtering and reducing is significantly faster than starting from scratch. Crossfilter uses sorted indexes (and a few bit-twiddling hacks) to make this possible, dramatically increasing the perfor&shy;mance of live histograms and top-<i>K</i> lists. For more details on how Crossfilter works, see the <a href="https://github.com/square/crossfilter/wiki/API-Refe...(line truncated)...
                ...
                <!-- file upload for map -->
                <input type="file" id="input" class="button" multiple><br/>
                ...
                <div class='container' style='font: 12px sans-serif; width: 110%'>
                    ...
                    <div class='row'>
                        <div class='span12'>
                            <table class='table table-hover' id='dc-table-graph' style="width: 90%">
                                <thead>
                                    <tr class='header'>
